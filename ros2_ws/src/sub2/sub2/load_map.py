...
class loadMap(Node):
    ...
    def __init__(self):
        ...
        grid=np.reshape(grid,(map_size_y, map_size_x))
        ...
        grid=np.reshape(map_to_grid,(map_size_y, map_size_x))
                ...
                if grid[x][y]==100 :
                    ...
                    for box_x in range(-5,6):
                        for box_y in range(-5,6):
                            if  0< x+box_x < map_size_x and 0 < y+box_y <map_size_y and grid[x+box_x][y+box_y]<80 :
                                grid[x+box_x][y+box_y]=127

        
        np_map_data=grid.reshape(1,map_size_y*map_size_x) 
